...
def home(request):
    ...
    if data_dic['user_id']:
       ...
       print(data_dic['userinfo'].subject1.split('(')[0])
       data_dic['articles'] = Article.objects.filter(subject1 = data_dic['userinfo'].subject1.split('(')[0])[::-1][:10]

    else :
       data_dic['articles']=Article.objects.all()[::-1][:10]
